...
assert(missingResult?.error === "requested file does not exist" && !JSON.stringify(missing.request).includes(missing.workspace), "missing read sends bounded no-path failure");
