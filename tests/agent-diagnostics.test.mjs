...
try {
  ...
  const run = { runId: "run_diag", status: "failed", terminalReason: "provider_error", turns: 1, events: [{ type: "tool_call", toolCallId: "tool_1_1", toolName: "read", summary: { path: "README.md" } }, { type: "tool_execution_end", toolCallId: "tool_1_1", success: false }, { type: "tool_result", toolCallId: "tool_1_1", errorCode: "execution_error", summary: {} }] };
  ...
  assert(!text.includes(raw) && !text.includes("README.md") && text.includes("execution_error") && text.includes("unknown_provider_error"), "diagnostic uses allowlisted safe fields only");
