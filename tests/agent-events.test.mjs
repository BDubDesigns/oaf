...
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "echo UNLABELED_SECRET", redacted: false, mode: null } }), /Non-redacted command must be a canonical recordable command/, "arbitrary command with redacted false rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "echo UNLABELED_SECRET", redacted: true, mode: null } }), /Redacted command must be exactly/, "arbitrary command with redacted true rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "pnpm test", redacted: true, mode: null } }), /Redacted command must be exactly/, "canonical command with redacted true rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "<redacted command>", redacted: false, mode: null } }), /Non-redacted command must be a canonical recordable command/, "redacted marker with redacted false rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "", redacted: false, mode: null } }), /Non-redacted command must be a canonical recordable command/, "empty command rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "pnpm test && echo x", redacted: false, mode: null } }), /Non-redacted command must be a canonical recordable command/, "canonical-prefix command rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "pnpm test --unexpected", redacted: false, mode: null } }), /Non-redacted command must be a canonical recordable command/, "canonical command with extra args rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "pnpm test", redacted: false, mode: "invalid" } }), /Command mode must be a valid sandbox mode or null/, "invalid command mode rejected");
throws(() => createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "pnpm test", redacted: false, mode: "test", network: false } }), /Unsupported tool summary field/, "model authorization claim rejected from audit summary");
...
for (const canonical of ["pnpm test", "pnpm lint", "pnpm typecheck", "pnpm build", "git status", "git diff", "git log --oneline"]) {
  assert(createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: canonical, redacted: false, mode: null } }).summary.command === canonical, `canonical command accepted: ${canonical}`);
}
assert(createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "<redacted command>", redacted: true, mode: null } }).summary.redacted === true, "exact redacted marker summary accepted");
assert(createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "pnpm test", redacted: false, mode: "test" } }).summary.mode === "test", "valid command mode accepted");
assert(createEvent("tool_call", { toolCallId: "tool_1_1", toolName: "command", summary: { command: "pnpm test", redacted: false, mode: null } }).summary.mode === null, "null command mode accepted");
