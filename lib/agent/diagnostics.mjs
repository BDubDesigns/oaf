...
import { DIAGNOSTIC_TOOL_OUTCOMES, PROVIDER_ATTEMPT_OUTCOMES, RUN_TERMINALS, TOOL_NAMES } from "./contracts.ts";
...
const VALID_PROVIDERS = new Set(["openai-compatible"]);
const PROVIDER_OUTCOMES = new Set(PROVIDER_ATTEMPT_OUTCOMES);
