...
import { CANONICAL_COMMANDS, canonicalCommand } from "../command-policy.mjs";
...
export const COMMAND_MODES = new Set(SANDBOX_MODES);
...
export function summarizeCommand(command) {
  if (typeof command !== "string" || canonicalCommand(command) === null) {
...
export function validateCommandSummary(fields) {
  ...
  if (fields.redacted === true) {
    ...
    if (canonicalCommand(fields.command) === null) {
