...
/** @typedef {import("./contracts.ts").AgentRunResult} AgentRunResult */
...
import { buildToolProtocol, normalizeProviderAttempt, ProviderFailure, validateProviderCall } from "./provider.mjs";
