  ...
  command: {
    ...
    argsSchema: {
      ...
      properties: {
        ...
        network: { type: "boolean", description: "Request network on; defaults false (internet-off)" },
        confirm: { type: "boolean", description: "Request confirmation; absent = fail closed" },
      },
      required: ["command"],
    },
    resultSchema: {
