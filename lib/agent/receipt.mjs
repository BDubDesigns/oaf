...
import { buildDiagnostic } from "./diagnostics.mjs";
...
export class ReceiptWriteError extends Error {
  constructor(diagnostic) { super("receipt could not be written"); this.code = "RECEIPT_WRITE_FAILED"; this.diagnostic = diagnostic; }
}
