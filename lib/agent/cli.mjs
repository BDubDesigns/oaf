...
export function usageFrom(run, config) {
  ...
  return { provider: "openai-compatible", model: config.model.trim(), runMode: /** @type {"agent"} */ ("agent"), calls: run.turns, tokensIn: sum("inputTokens"), tokensOut: sum("outputTokens") };
}
